...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("守衛を倒す", "mechanical", "attack_action"),
        ("守衛を倒さない", "narrative", "narrative_or_fallback"),
        ("守衛を倒すな", "narrative", "narrative_or_fallback"),
        ("『守衛を倒す』と彼は言った", "narrative", "narrative_or_fallback"),
